...
export default function App() {
	...
	function showModal(e: BaseSyntheticEvent) {
		e.preventDefault();
		setModalOpen(true);
	}
	...
	return (
		<>
			<div className="container relative p-4 mx-auto xl:px-24 lg:px-16">
				...
				<main className="pt-12">
					...
					<section className="flex flex-row items-start text-center">
						...
						<div>
							<a href="#" onClick={showModal} className="mb-4 call-to-action leading-[0.75] no-underline flex gap-[.25em] text-5xl lg:text-8xl w-min items-center mx-auto">
								<span>»</span>
			...
			<WizardModal openModal={modalOpen} setModalOpen={setModalOpen} />
		</>
	);
};
